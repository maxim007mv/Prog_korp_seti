...
namespace Restaurant.Infrastructure.Migrations
{
    ...
    [Migration("20251029055257_AddPerformanceIndexes")]
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex("ClientName", "ClientPhone", "Status")
                        .HasDatabaseName("idx_bookings_search");

                    b.HasIndex("TableId", "Status", "StartTime", "EndTime")
                        .HasDatabaseName("idx_bookings_table_status_time")
                        .HasFilter("status = 'активно'");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Dish", b =>
                {
                    ...
                    b.HasIndex("IsAvailable", "IsDeleted", "CategoryId")
                        .HasDatabaseName("idx_dishes_menu")
                        .HasFilter("is_available = true AND is_deleted = false");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("Status", "EndTime")
                        ...
                        .HasFilter("status = 'завершен'");

                    b.HasIndex("WaiterId", "Status", "ShiftDate")
